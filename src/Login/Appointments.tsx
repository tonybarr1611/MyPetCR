...
const Appointments = () => {
  ...
  const [appointments, setAppointments] = useState([
    { id: 1, owner: '<Tony', pet: 'Buddy', veterinary: 123, store: 'Pet Store 1', status: 'Pending', dateTime: '2024-06-15 10:00 AM' },
    { id: 1, owner: '<Tony', pet: 'Buddy', veterinary: 123, store: 'Pet Store 1', status: 'Pending', dateTime: '2024-06-15 10:00 AM' },
    { id: 1, owner: '<Tony', pet: 'Buddy', veterinary: 123, store: 'Pet Store 1', status: 'Pending', dateTime: '2024-06-15 10:00 AM' },
    { id: 1, owner: '<Tony', pet: 'Buddy', veterinary: 123, store: 'Pet Store 1', status: 'Pending', dateTime: '2024-06-15 10:00 AM' },
    { id: 1, owner: '<Tony', pet: 'Buddy', veterinary: 123, store: 'Pet Store 1', status: 'Pending', dateTime: '2024-06-15 10:00 AM' },
        ...
        <Col md={10}>
          <Form onSubmit={handleSubmit} className="mb-3">
            <Row>
              ...
              <Col xs="auto">
                <Button variant="primary" type="button" className='me-2' onClick={handleAddAppointment}>
                  <PlusLg />
                </Button>
              </Col>
            </Row>
                  ...
                  <tr key={index}>
                    ...
                    <td className="text-center">
                      <div className="d-flex justify-content-center">
                        <Button variant="primary" size="sm" className=" mr-2" onClick={() => handleEditAppointment(appointment.id)}>
                          Edit
                        </Button>
